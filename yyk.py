...
satpam.login(token="EmHzDHFAHK63zfrxLOI0.vrqhVOQfV2TMZHni0Q9v4a.FcSeyTqZ+Gbx/aDzKEaFNgRfreOn0ytvrzWjG7KeL8U=")
satpam.loginResult()

cl = LINETCR.LINE() #Luffy
cl.login(token="Emcf1mkl5VNfCfGNksK5.SaTSn2BFBCK7ONlLf9gqnq.MMA2BpBf8gqlhkO6l6gownRxWKjeM6E/uLe8EqILWWk=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="Em8sm4ri2PAWN27QpS6a.FWFf9nGb8R6ZTRmGVofIcG.KzXfqxjTJZ8aKnNYgizFvJyzIF20JzP7ot1vImMtglw=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EmGHZ5nw2WlwIUuNZrZb.uHY7f+AttUvROjvPFl4vAW.klIwEpT074FXTmbKIF0qWXXqosiTqH6ESOxJCagCMao=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Em2fqdQbMaHCTFix3Vf8.qF/SdCR8GYpvM9KWtutZoa.Fs6W4DZR2qxq3/fteuC5DmuYX3yUcyJ6r6sbIVYIdMQ=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="Ema1SY2SNWGRJAXvbL74.6tWIH6klR7HTWSJ5CpQYPa.UXkaCoQ7AGEJUKb8X9NtZgz6PtokG5MXJJLYWOkphnY=")
ks.loginResult()

ka = LINETCR.LINE() #Franky
ka.login(token="EmNhkHg5eBwsaokgIJS6.5rA7YLcz5DuHM6CWLzyBzG.zyY1zUoID1E572dlBhkd7QR5S+QjUBe2vqIyx8EP/BQ=")
ka.loginResult()

kb = LINETCR.LINE() #Brook
kb.login(token="EmHjwVr2VwODV581ZBhd.ZsGVOfe5SEn51RtE9e4oBq.fYEdpeF3V2JlTobDl/AVnH8S1u2Q4POxIp7Is74xOzk=")
kb.loginResult()

ko = LINETCR.LINE() #Nami
ko.login(token="EmxFvkDNIYB9T1AlbRk9.sO9BRAbp/dsIAF4zCdJSQq.W5BZ/4/PPRwZeeE06XXGNIhtttLtIe/LQkML3YxsIvM=")
ko.loginResult()

ke = LINETCR.LINE() #Robin
ke.login(token="EmOSJjqwi03Ftq9zomY1.z0m06TNXOjLNrBZfAvMCOq.fD9/BD4rVLT6i2B+nOiyEQOqnyd5WgwwhQrjv03GJWQ=")
ke.loginResult()

ku = LINETCR.LINE() # Jinbei
ku.login(token="EmI0C6eBct9jAaubIm9e.HufDHz5wh4GqB3n6FcHZZG.nJ8v2WU86ga8iBri117VUCRD1O0VnQVe5+FxfTEmwaE=")
ku.loginResult()
...
k1.login(token="Emgc7yEjk1RU9I3uPLJd.90U0gMLw4ZUiDnyCqIvQdq.nrMmKgWO0kEoCRjc0/4ozIFwRcgyRODiGbmSdwsx3KE=")
k1.loginResult()
...
!Command Admin!
=> My mid = Menampilkan mId Bot Utama
=> Mid Bot = Menampilkan Mid All Bot
=> Mid @ = Menampilkan Mid By Tag
=> Contact on/off = Cek Mid Send Contact
...
=> Cctv > Ciduk = Check Sider
=> Kuy = Semua bot join
=> Kabur all = Semua bot Keluar Dari Grup


!CommandPenting!
=> Guest On/Off = AutoKick Bagi Yang Menginvite,Mengkick
=> Qr On/Off = AutoKick Bagi Yang Membuka QR
=> Joinn On/Off = AutoKick Bagi Yang join 
=> Cancel On/Off = Batalkan Semua Undangan
=> Banned @ = Ban Menggunakan Tag
=> Unban @ = Unban Menggunakan Tag
=> Kill Ban/Kill = Kill Yang DiBan
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,"udc7ce8646bbe9a2c6b32ff4d0ba586e1","uf74bb41a6956e33b8874d61c42256a0d"]
admin=["udc7ce8646bbe9a2c6b32ff4d0ba586e1","u74927467b80b399ca6e5c9082dd910b9","uf74bb41a6956e33b8874d61c42256a0d"] 
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Terima Kasih Sudah Menambahkan Aku Jadi Teman""",
    "lang":"JP",
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Ko\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","INC FORCE","Join kuy"]:
              if msg.from_ in owner:
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by inc_9 ")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by inc_9 ")
                    print "Like"
                except:
                    pass
            else:
